...
class Android3DView extends GLSurfaceView {
    private static String TAG = Android3DView.class.getSimpleName();
    ...
    public Android3DView(Context context, boolean translucent, int depth, int stencil) {
        super(context);
    ...
    private void init(boolean translucent, int depth, int stencil) {
        ...
        setRenderer(new Android3DRender());
    }
